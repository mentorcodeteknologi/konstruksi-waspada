          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mb-4">
                ...
                <input type="text" name="nominal_kerugian" id="nominal_kerugian" class="form-control" placeholder="Nominal Kerugian" value="<?= $detail_perusahaan_blacklist['nominal_kerugian'] ?>" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="mb-4">
