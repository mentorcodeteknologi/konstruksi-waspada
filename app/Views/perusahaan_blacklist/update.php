                    ...
                    <div class="col-sm-12 ">
                        ...
                        <form action="<?= base_url('perusahaan_blacklist/update/' . $detail_perusahaan_blacklist['slug']) ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="mulai_rental" id="mulai_rental" class="form-control" placeholder="mulai_rental" value="<?= date('Y-m-d', strtotime($detail_perusahaan_blacklist['mulai_rental'])) ?>" required value="<?= date('Y-m-d') ?>">
                            </div>

                            <div class="form-group">
                                <label>Akhir Rental</label>
                                <input type="date" name="akhir_rental" id="akhir_rental" class="form-control" placeholder="akhir_rental" value="<?= date('Y-m-d', strtotime($detail_perusahaan_blacklist['akhir_rental'])) ?>" required value="<?= date('Y-m-d') ?>">
                            </div>
