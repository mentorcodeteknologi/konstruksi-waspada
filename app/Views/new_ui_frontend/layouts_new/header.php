                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse first-level my-3">
                                ...
                                <ul class="px-8 mt-7 mb-4">
                                    ...
                                    <li class="sidebar-item py-2">
                                        <a class="fw-semibold text-dark" href="../horizontal/authentication-login.html">Authentication Design</a>
                                    </li>
                                    <li class="sidebar-item py-2">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-xl-block">
                    <a href="../horizontal/index.html" class="text-nowrap nav-link">
                        <img src="<?= base_url('assets/new_frontend') ?>/images/logos/dark-logo.svg" class="dark-logo" width="180" alt="" />
                        <img src="<?= base_url('assets/new_frontend') ?>/images/logos/light-logo.svg" class="light-logo" width="180" alt="" />
                    </a>
                </li>
                <li class="nav-item d-none d-xl-block">
                    <a class="nav-link nav-icon-hover" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal">
