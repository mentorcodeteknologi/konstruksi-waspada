                            ...
                            <?php else : ?>
                                <div class="col-md-4">
                                    <div class="card hover-img <?= $is_logged_in ? '' : 'blur' ?>">
                                        <div class="card-body p-4 text-center border-bottom">
                                            <img src="<?= base_url('assets/new_frontend') ?>/images/profile/user-1.jpg" alt="" class="rounded-circle mb-3" width="80" height="80">
                                            <h5 class="fw-semibold mb-0 fs-5">Nama Terlapor : xxxxxxxxx</h5>
                                            <h6 class="text-dark fs-2">NIK terlapor : xxxxxxxxx</h6>
                                            <h6 class="text-dark fs-2">Jenis Pelanggaran : xxxxxxxxx</h6>
                                            <h6 class="text-dark fs-2">Nominal Kerugian : xxxxxxxxx</h6>
                                        </div>
                                        <ul class="px-2 py-2 list-unstyled d-flex align-items-center justify-content-center mb-0">
                                            <button class="btn bg-primary-subtle text-primary mb-3 w-50">Detail</button>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-4">
