...
<head>
    ...
    <link rel="icon" href="<?= base_url('assets/backend') ?>/images/dashboard/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="<?= base_url('assets/backend') ?>/images/dashboard/favicon.png" type="image/x-icon">
    <title><?= $title ?> | TotalStation</title>
    ...
    <!-- Font Awesome-->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/backend') ?>/css/vendors/font-awesome.css">

    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/backend') ?>/css/vendors/flag-icon.css">

    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/backend') ?>/css/vendors/icofont.css">
